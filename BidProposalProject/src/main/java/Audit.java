	...
	public void add(String addition) {
		if (doAudit) {
			...
			try {
				...
				writer.write(String.format("%d//%d  %02d:%02d:%02d : %s", LocalDateTime.now().getMonthValue(),
